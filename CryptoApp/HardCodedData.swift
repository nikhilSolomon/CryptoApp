...
let user1 = User(id: "123456", userName: "johndoe", password: "secretpassword", cryptoWallet: wallet, balance: 5000.00, favoriteCoinList: ["BTC", "ETH"], lastLoggedIn: Date(), dateOfJoining: Date(timeIntervalSinceNow: -86400))
